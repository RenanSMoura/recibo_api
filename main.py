...
def print_hi(name):
    ...
    #     user_title="Sr",
    #     session_price="160",
    #     session_days=['2/08', '9/08', '16/08', '23/08', '30/08']
    # )
    #
    # mayara = User(
    ...
    #     user_title="Sra",
    #     session_price="130",
    #     session_days=['3/08', '10/08', '17/08', '24/08'],
    #
    # )
